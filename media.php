...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="media_handle.php" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="<?= $edited_user_id['img'] ? $edited_user_id['img'] : 'img/demo/avatars/avatar-m.png';?>" alt="" class="img-responsive" width="200">
                                </div>
