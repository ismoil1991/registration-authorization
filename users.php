            ...
            <div class="col-xl-4">
                <div id="c_<?= $user['id']; ?>" class="card border shadow-0 mb-g shadow-sm-hover"
                    ...
                    <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                        <div class="d-flex flex-row align-items-center">
                            ...
                            <div class="info-card-text flex-1">
                                <a href="page_profile.php?id=<?= $user['id']; ?>"><?= $user['fname']; ?></a>
                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            <a href="tel:<?= $user['phone_link_href']; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                            ...
                            <div class="d-flex flex-row">
                                <a href="javascript:<?= $user['vk_link_href']; ?>" class="mr-2 fs-xxl"
                                   style="color:<?= $user['vk_color']; ?>">
                                    <i class="fab fa-vk"></i>
                                </a>
                                <a href="javascript:<?= $user['telegram_link_href']; ?>" class="mr-2 fs-xxl"
                                   style="color:<?= $user['telegram_color']; ?>">
                                    <i class="fab fa-telegram"></i>
                                </a>
                                <a href="javascript:<?= $user['instagram_link_href']; ?>" class="mr-2 fs-xxl"
                                   style="color:<?= $user['instagram_color']; ?>">
